...
<html>
    <head>
        ...
        <?php $nav_en_cours = 'nosrestaurants'; ?>
    </head>
    ...
    <body>
        ...
        <section class="container"><!--our restaurants-->
            <div class="title-div">
                ...
                <h1 class="text-center title-heading">Trouver votre restaurant BugCookers</h1>
            ...
            <div class="row "><!--restaurants thumbnail-->
                <div class="col-xs-12">
                    <div class="restaurant-location">
                        <div class="col-thumbnail" id="loupe"><!--La loupe-->
                            <div class="thumbnail text-center restaurant-thumbnail">
                                <div class="caption">
                                    ...
                                    <p class="text-center">laloupe@bugcookers.com</p>
                                    <a class="btn btn-color" href="nosMenus.php#spe-loupe" role="button">Nos specialités</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-thumbnail" id="orleans"><!--Orléans-->
                            <div class="thumbnail text-center restaurant-thumbnail">
                                <div class="caption">
                                    <h3>Orléans</h3>
                                    ...
                                    <p class="text-center">orleans@bugcookers.com</p>
                                    <a class="btn btn-color" href="nosMenus.php#spe-orleans" role="button">Nos specialités</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-thumbnail" id="bordeaux"> <!--Bordeaux-->
                            <div class="thumbnail text-center restaurant-thumbnail">
                                <div class="caption">
                                    <h3>Bordeaux</h3>
                                    ...
                                    <p class="text-center">bordeaux@bugcookers.com</p>
                                    <a class="btn btn-color" href="nosMenus.php#spe-bordeaux" role="button">Nos specialités</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-thumbnail" id="lyon"><!--Lyon-->
                            <div class="thumbnail text-center restaurant-thumbnail">
                                <div class="caption">
                                    <h3>Lyon</h3>
                                    ...
                                    <p class="text-center">lyon@bugcookers.com</p>
                                    <a class="btn btn-color" href="nosMenus.php#spe-lyon" role="button">Nos specialités</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-thumbnail" id="toulouse"><!--Toulouse-->
                            <div class="thumbnail text-center restaurant-thumbnail">
                                <div class="caption">
                                    <h3 >Toulouse</h3>
                        ...
                        <div class="col-thumbnail" id="lille"><!--Lille-->
                            <div class="thumbnail text-center restaurant-thumbnail">
                                <div class="caption">
                                    <h3 >Lille</h3>
                                    ...
                                    <p class="text-center">lille@bugcookers.com</p>
                                    <a class="btn btn-color" href="nosMenus.php#spe-lille" role="button">Nos specialités</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-thumbnail" id="strasbourg"><!--Strasbourg-->
                            <div class="thumbnail text-center restaurant-thumbnail">
                                <div class="caption">
                                    <h3>Strasbourg</h3>
                        ...
                        <div class="col-thumbnail" id="paris"><!--Paris-->
                            <div class="thumbnail text-center restaurant-thumbnail">
                                <div class="caption">
                                    <h3 >Paris</h3>
                                    ...
                                    <p class="text-center">paris@bugcookers.com</p>
                                    <a class="btn btn-color" href="nosMenus.php#spe-paris" role="button">Nos specialités</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-thumbnail" id="reims"><!--Reims-->
                            <div class="thumbnail text-center restaurant-thumbnail">
                                <div class="caption">
                                    <h3 >Reims</h3>
                                    ...
                                    <p class="text-center">reims@bugcookers.com</p>
                                    <a class="btn btn-color" href="nosMenus.php#spe-reims" role="button">Nos specialités</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-thumbnail" id="biarritz"><!--Biarritz-->
                            <div class="thumbnail text-center restaurant-thumbnail">
                                <div class="caption">
                                    <h3>Biarritz</h3>
                                    ...
                                    <p class="text-center">biarritz@bugcookers.com</p>
                                    <a class="btn btn-color" href="nosMenus.php#spe-biarritz" role="button">Nos specialités</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section id="contact-section"><!--contact section-->
            <div class="container">
                <div class="title-div">
                    <div class="left-line"></div>
                    <h1 class="text-center title-heading">Une question, une suggestion ? Contactez-nous</h1>
                    <div class="right-line"></div>
                </div>
                <div class="row">
                    <div class="col-sm-4 col-sm-offset-4 col-xs-8 col-xs-offset-2">
                        <form method="post" name="formInformation">
                            ...
                            <input id="name" type="text" name="name"class="form-control" placeholder="Julien Boyer"/>
                            <label for="email">Email :</label>
                            <input id="email" type="email" name="email"class="form-control" placeholder="julien.boyer@chihuahua.com"/>
                            <label for="textarea">Message :</label>
                            <textarea class="form-control" rows="3" id="textarea">Joyeux Anniversaire</textarea>
